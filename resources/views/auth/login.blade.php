...
<section class="container">
    ...
    <form action="{{ route('login') }}" class="form" method="POST">
        ...
        <div class="form-group">
            <input id="password" type="password" placeholder="Password" minlength="4" class="@error('password') is-invalid @enderror" name="password" required autocomplete="current-password"/>
